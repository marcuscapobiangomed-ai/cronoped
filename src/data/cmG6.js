// Clínica Médica — Grupo 6 — Cronograma 2026.1
export const CM_G6 = [
  {num:1,dates:"23/2 – 28/2",activities:[
      {id:"1-1",day:"2ª",turno:"Manhã",title:"AMBULAT. DE CM",sub:"Prof. Luciano",time:"09:00–12:00",type:"ambulatorio",loc:"Pavilhão Silva Melo"},
  ...
  {num:6,dates:"30/3 – 04/4",activities:[
      {id:"6-1",day:"2ª",turno:"Manhã",title:"ENFERMARIA DE CM",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"6-2",day:"2ª",turno:"Tarde",title:"AMBULAT. DE NEFRO",sub:"Profa. Ana Paula",time:"14:00–17:00",type:"ambulatorio",loc:"Pavilhão Silva Melo"},
      {id:"6-3",day:"3ª",turno:"Manhã",title:"ENFERMARIA DE CM",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"6-4",day:"3ª",turno:"Tarde",title:"Consolidação e Performance",sub:"Em Casa",time:"14:00–18:00",type:"casa"},
      {id:"6-5",day:"4ª",turno:"Manhã",title:"ENFERMARIA DE CM",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"6-6",day:"4ª",turno:"Tarde",title:"Consolidação e Performance",sub:"Em Casa",time:"14:00–18:00",type:"casa"},
      {id:"6-7",day:"5ª",turno:"Manhã",title:"ENFERMARIA DE CM",sub:"",time:"08:00–12:00",type:"enfermaria"},
  ...
  {num:7,dates:"06/4 – 11/4",activities:[
      {id:"7-1",day:"2ª",turno:"Manhã",title:"ENFERMARIA DE CARDIO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"7-2",day:"2ª",turno:"Tarde",title:"AMBULAT. DE CARDIO HUV",sub:"",time:"14:00–17:00",type:"ambulatorio",loc:"HUV"},
      {id:"7-3",day:"3ª",turno:"Manhã",title:"ENFERMARIA DE CARDIO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"7-4",day:"3ª",turno:"Tarde",title:"AMBULAT. DE PSIQUIATRIA",sub:"Prof. Jean",time:"13:00–16:00",type:"ambulatorio"},
      {id:"7-5",day:"4ª",turno:"Manhã",title:"ENFERMARIA DE CARDIO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"7-6",day:"4ª",turno:"Tarde",title:"Consolidação e Performance",sub:"Em Casa",time:"14:00–18:00",type:"casa"},
      {id:"7-7",day:"5ª",turno:"Manhã",title:"ENFERMARIA DE CARDIO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"7-8",day:"5ª",turno:"Tarde",title:"Consolidação e Performance",sub:"Em Casa",time:"14:00–18:00",type:"casa"},
      {id:"7-9",day:"6ª",turno:"Manhã",title:"ENFERMARIA DE CARDIO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"7-10",day:"6ª",turno:"Tarde",title:"Horário Verde",sub:"",time:"",type:"verde"},
      {id:"7-11",day:"Sáb",turno:"Manhã",title:"ENFERMARIA DE CARDIO",sub:"",time:"08:00–12:00",type:"enfermaria"}
  ]},
  {num:8,dates:"13/4 – 18/4",activities:[
      {id:"8-1",day:"2ª",turno:"Manhã",title:"ENFERMARIA DE NEFRO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"8-2",day:"2ª",turno:"Tarde",title:"AMBULAT. DE CM",sub:"Precep. Aline",time:"14:00–17:00",type:"ambulatorio"},
      {id:"8-3",day:"3ª",turno:"Manhã",title:"ENFERMARIA DE NEFRO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"8-4",day:"3ª",turno:"Tarde",title:"Consolidação e Performance",sub:"Em Casa",time:"14:00–18:00",type:"casa"},
      {id:"8-5",day:"4ª",turno:"Manhã",title:"ENFERMARIA DE NEFRO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"8-6",day:"4ª",turno:"Tarde",title:"Consolidação e Performance",sub:"Em Casa",time:"14:00–18:00",type:"casa"},
      {id:"8-7",day:"5ª",turno:"Manhã",title:"ENFERMARIA DE NEFRO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"8-8",day:"5ª",turno:"Tarde",title:"Horário Verde",sub:"",time:"",type:"verde"},
      {id:"8-9",day:"6ª",turno:"Manhã",title:"ENFERMARIA DE NEFRO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"8-10",day:"6ª",turno:"Tarde",title:"AMBULAT. DE PNEUMO",sub:"Prof. Célio",time:"14:00–17:00",type:"ambulatorio",loc:"Pavilhão Silva Melo"},
  ...
  {num:9,dates:"20/4 – 25/4",activities:[
      {id:"9-1",day:"2ª",turno:"Manhã",title:"AMBULAT. DE NEFRO",sub:"Profa. Ana Paula",time:"08:00–12:00",type:"ambulatorio"},
      {id:"9-2",day:"2ª",turno:"Tarde",title:"AMBULAT. DE REUMATO",sub:"Prof. Da Disciplina",time:"14:00–17:00",type:"ambulatorio"},
  ...
  {num:10,dates:"27/4 – 02/5",activities:[
      {id:"10-1",day:"2ª",turno:"Manhã",title:"AMBULAT. DE REUMATO",sub:"Prof. Da Disciplina",time:"08:00–12:00",type:"ambulatorio"},
      {id:"10-2",day:"2ª",turno:"Tarde",title:"Horário Verde",sub:"",time:"",type:"verde"},
      {id:"10-3",day:"3ª",turno:"Manhã",title:"AMBULAT. DE DERMATO",sub:"Profa. Cristiane",time:"08:00–12:00",type:"ambulatorio"},
      ...
      {id:"10-6",day:"4ª",turno:"Tarde",title:"AMBULAT. DE CM",sub:"Precep. Thaís",time:"14:00–17:00",type:"ambulatorio"},
      {id:"10-7",day:"5ª",turno:"Manhã",title:"Consolidação e Performance",sub:"Em Casa",time:"08:00–12:00",type:"casa"},
      {id:"10-8",day:"5ª",turno:"Tarde",title:"AMBULAT. DE NEURO",sub:"Profa. Priscila",time:"14:00–17:00",type:"ambulatorio"},
