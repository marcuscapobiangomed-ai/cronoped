// Clínica Médica — Grupo 1 — Cronograma 2026.1
export const CM_G1 = [
  {num:1,dates:"23/2 – 28/2",activities:[
      {id:"1-1",day:"2ª",turno:"Manhã",title:"ENFERMARIA DE CM",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"1-2",day:"2ª",turno:"Tarde",title:"AMBULAT. DE NEFRO",sub:"Profa. Ana Paula",time:"14:00–17:00",type:"ambulatorio",loc:"Pavilhão Silva Melo"},
      {id:"1-3",day:"3ª",turno:"Manhã",title:"ENFERMARIA DE CM",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"1-4",day:"3ª",turno:"Tarde",title:"Consolidação e Performance",sub:"Em Casa",time:"14:00–18:00",type:"casa"},
      {id:"1-5",day:"4ª",turno:"Manhã",title:"ENFERMARIA DE CM",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"1-6",day:"4ª",turno:"Tarde",title:"Consolidação e Performance",sub:"Em Casa",time:"14:00–18:00",type:"casa"},
      {id:"1-7",day:"5ª",turno:"Manhã",title:"ENFERMARIA DE CM",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"1-8",day:"5ª",turno:"Tarde",title:"Consolidação e Performance",sub:"Em Casa",time:"14:00–18:00",type:"casa"},
      {id:"1-9",day:"6ª",turno:"Manhã",title:"ENFERMARIA DE CM",sub:"",time:"08:00–12:00",type:"enfermaria"},
  ...
  {num:2,dates:"02/3 – 07/3",activities:[
      {id:"2-1",day:"2ª",turno:"Manhã",title:"ENFERMARIA DE CARDIO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"2-2",day:"2ª",turno:"Tarde",title:"AMBULAT. DE CARDIO HUV",sub:"",time:"14:00–17:00",type:"ambulatorio",loc:"HUV"},
      {id:"2-3",day:"3ª",turno:"Manhã",title:"ENFERMARIA DE CARDIO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"2-4",day:"3ª",turno:"Tarde",title:"AMBULAT. DE PSIQUIATRIA",sub:"Prof. Jean",time:"13:00–16:00",type:"ambulatorio"},
      {id:"2-5",day:"4ª",turno:"Manhã",title:"ENFERMARIA DE CARDIO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"2-6",day:"4ª",turno:"Tarde",title:"Consolidação e Performance",sub:"Em Casa",time:"14:00–18:00",type:"casa"},
      {id:"2-7",day:"5ª",turno:"Manhã",title:"ENFERMARIA DE CARDIO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"2-8",day:"5ª",turno:"Tarde",title:"Consolidação e Performance",sub:"Em Casa",time:"14:00–18:00",type:"casa"},
      {id:"2-9",day:"6ª",turno:"Manhã",title:"ENFERMARIA DE CARDIO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"2-10",day:"6ª",turno:"Tarde",title:"Horário Verde",sub:"",time:"",type:"verde"},
      {id:"2-11",day:"Sáb",turno:"Manhã",title:"ENFERMARIA DE CARDIO",sub:"",time:"08:00–12:00",type:"enfermaria"}
  ]},
  {num:3,dates:"09/3 – 14/3",activities:[
      {id:"3-1",day:"2ª",turno:"Manhã",title:"ENFERMARIA DE NEFRO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"3-2",day:"2ª",turno:"Tarde",title:"AMBULAT. DE CM",sub:"Precep. Aline",time:"14:00–17:00",type:"ambulatorio"},
      {id:"3-3",day:"3ª",turno:"Manhã",title:"ENFERMARIA DE NEFRO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"3-4",day:"3ª",turno:"Tarde",title:"Consolidação e Performance",sub:"Em Casa",time:"14:00–18:00",type:"casa"},
      {id:"3-5",day:"4ª",turno:"Manhã",title:"ENFERMARIA DE NEFRO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"3-6",day:"4ª",turno:"Tarde",title:"Consolidação e Performance",sub:"Em Casa",time:"14:00–18:00",type:"casa"},
      {id:"3-7",day:"5ª",turno:"Manhã",title:"ENFERMARIA DE NEFRO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"3-8",day:"5ª",turno:"Tarde",title:"Horário Verde",sub:"",time:"",type:"verde"},
      {id:"3-9",day:"6ª",turno:"Manhã",title:"ENFERMARIA DE NEFRO",sub:"",time:"08:00–12:00",type:"enfermaria"},
      {id:"3-10",day:"6ª",turno:"Tarde",title:"AMBULAT. DE PNEUMO",sub:"Prof. Célio",time:"14:00–17:00",type:"ambulatorio",loc:"Pavilhão Silva Melo"},
      {id:"3-11",day:"Sáb",turno:"Manhã",title:"ENFERMARIA DE NEFRO",sub:"",time:"08:00–12:00",type:"enfermaria"}
  ]},
  {num:4,dates:"16/3 – 21/3",activities:[
      {id:"4-1",day:"2ª",turno:"Manhã",title:"AMBULAT. DE NEFRO",sub:"Profa. Ana Paula",time:"08:00–12:00",type:"ambulatorio"},
      {id:"4-2",day:"2ª",turno:"Tarde",title:"AMBULAT. DE REUMATO",sub:"Prof. Da Disciplina",time:"14:00–17:00",type:"ambulatorio"},
      {id:"4-3",day:"3ª",turno:"Manhã",title:"AMBULAT. DE GERIATRIA",sub:"Prof. Leonardo",time:"08:00–12:00",type:"ambulatorio"},
      {id:"4-4",day:"3ª",turno:"Tarde",title:"AMBULAT. DE DERMATO",sub:"Profa. Cristiane",time:"14:00–17:00",type:"ambulatorio",loc:"Pavilhão Silva Melo"},
  ...
  {num:5,dates:"23/3 – 28/3",activities:[
      {id:"5-1",day:"2ª",turno:"Manhã",title:"AMBULAT. DE REUMATO",sub:"Prof. Da Disciplina",time:"08:00–12:00",type:"ambulatorio"},
      {id:"5-2",day:"2ª",turno:"Tarde",title:"Horário Verde",sub:"",time:"",type:"verde"},
      {id:"5-3",day:"3ª",turno:"Manhã",title:"AMBULAT. DE DERMATO",sub:"Profa. Cristiane",time:"08:00–12:00",type:"ambulatorio"},
      ...
      {id:"5-6",day:"4ª",turno:"Tarde",title:"AMBULAT. DE CM",sub:"Precep. Thaís",time:"14:00–17:00",type:"ambulatorio"},
      {id:"5-7",day:"5ª",turno:"Manhã",title:"Consolidação e Performance",sub:"Em Casa",time:"08:00–12:00",type:"casa"},
      {id:"5-8",day:"5ª",turno:"Tarde",title:"AMBULAT. DE NEURO",sub:"Profa. Priscila",time:"14:00–17:00",type:"ambulatorio"},
      {id:"5-9",day:"6ª",turno:"Manhã",title:"AMBULAT. DE NEURO",sub:"Profa. Priscila",time:"08:00–12:00",type:"ambulatorio"},
      {id:"5-10",day:"6ª",turno:"Tarde",title:"Horário Verde",sub:"",time:"",type:"verde"}
  ]},
  {num:6,dates:"30/3 – 04/4",activities:[
      {id:"6-1",day:"2ª",turno:"Manhã",title:"AMBULAT. DE CM",sub:"Prof. Luciano",time:"09:00–12:00",type:"ambulatorio",loc:"Pavilhão Silva Melo"},
  ...
  {num:9,dates:"20/4 – 25/4",activities:[
      ...
      {id:"9-4",day:"4ª",turno:"Manhã",title:"Mecanismos de abordagem ao paciente clínico – Enfermaria HUV",sub:"Profa. Ana Cláudia",time:"09:00–12:00",type:"enfermaria"},
      {id:"9-5",day:"4ª",turno:"Tarde",title:"Horário Verde",sub:"",time:"",type:"verde"},
      ...
      {id:"9-8",day:"6ª",turno:"Tarde",title:"ENFERMARIA DE CM",sub:"Prof. Jean",time:"14:00–17:00",type:"enfermaria"}
  ]},
